            ...
            <main className="overflow-hidden">
                    ...
                    <div className="relative pt-24 md:pt-36">
                        <AnimatedGroup
                            ...
                            <img
                                ...
                                alt="background"
                                className="absolute inset-x-0 top-56 -z-20 hidden lg:top-32 dark:block opacity-30 object-cover w-full h-[800px] mask-image-gradient"
                                width="3276"
                                height="4095"
                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">Version 1.3.0 is now live</span>
                                    ...
                                    <p
                                        ...
                                        Highly customizable QR codes for building modern campaigns. Track scans, update destinations instantly, and manage everything from our dashboard.
                                    </p>
                                </AnimatedGroup>
                                ...
                                <AnimatedGroup
                                    ...
                                    <Button
                                        ...
                                        <a href="https://github.com/Mojahid65/dynamqr/releases/latest/download/app-release.apk">
                            ...
                            <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                                ...
                                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                                    <img
                                        ...
                                        src="https://images.unsplash.com/photo-1618761714954-0b8cd0026356?auto=format&fit=crop&q=80&w=2700"
                                        alt="app screen"
                                        width="2700"
                                        height="1440"
                                    />
                ...
                <section className="bg-background pb-16 pt-16 md:pb-32">
                    <div className="group relative m-auto max-w-5xl px-6">
                        ...
                        <div className="group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14 opacity-50">
                            <div className="flex justify-center text-xl font-bold tracking-tighter">REACT</div>
                            <div className="flex justify-center text-xl font-bold tracking-tighter">VITE</div>
                            <div className="flex justify-center text-xl font-bold tracking-tighter">SUPABASE</div>
                            <div className="flex justify-center text-xl font-bold tracking-tighter">TAILWIND</div>
                            <div className="flex justify-center text-xl font-bold tracking-tighter">FLUTTER</div>
                            <div className="flex justify-center text-xl font-bold tracking-tighter">FIREBASE</div>
                            <div className="flex justify-center text-xl font-bold tracking-tighter">SHADCN</div>
                            <div className="flex justify-center text-xl font-bold tracking-tighter">TYPESCRIPT</div>
                        </div>
                    </div>
                </section>
            </main>
    ...
    return (
        <header>
            <nav
                ...
                className="fixed z-20 w-full px-2 group mt-4">
