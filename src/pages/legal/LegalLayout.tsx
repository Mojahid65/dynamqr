  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-40 -left-40 w-[600px] h-[600px] bg-primary/10 rounded-full blur-[128px]" />
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 md:px-12 py-5 border-b border-white/5 backdrop-blur-sm">
        <Link to="/landing" className="flex items-center gap-3 group">
          <div className="w-10 h-10 rounded-[2rem] bg-gradient-to-br from-primary to-violet-600 flex items-center justify-center shadow-lg shadow-primary/25">
      ...
      <main className="relative z-10 max-w-3xl mx-auto px-6 md:px-8 py-12 md:py-16">
        ...
        <article className="space-y-6 text-slate-300 leading-relaxed [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:tracking-tight [&_h2]:text-white [&_h2]:mt-12 [&_h2]:mb-4 [&_h3]:text-lg [&_h3]:font-bold [&_h3]:text-white [&_h3]:mt-8 [&_h3]:mb-3 [&_p]:leading-relaxed [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:space-y-2 [&_ol]:list-decimal [&_ol]:pl-6 [&_ol]:space-y-2 [&_li]:leading-relaxed [&_a]:text-primary [&_a:hover]:underline [&_strong]:text-white [&_code]:bg-surface/10 [&_code]:rounded [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:text-sm">
          {children}
        </article>
      </main>
